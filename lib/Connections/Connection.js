...
class Connection extends PartialConnection {
     ...
     * @param {*} Value A value to push to this array.
     * @returns {Connection} Returns the updated database.
     */
    Push (KeyOrPath, Value) {
        if (!this._Ready) return null;
        if (typeof KeyOrPath !== "string") return null;
    ...
    Modify (KeyOrPath, Fn) {
        ...
        // Assuming this is cached, it would be fast!
        // Integrate an "internal cache" which would evict it later?
