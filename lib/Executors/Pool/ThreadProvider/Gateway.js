...
class Gateway {
     ...
     * @returns {Promise} Result from the thread.
     */
    async Set (KeyOrPath, Value) {
        if (!this._ThreadProvider) return null;
        return this._ThreadProvider.Query("Set", [KeyOrPath, Value]);
    }
    ...
    async Fetch (KeyOrPath) {
        if (!this._ThreadProvider) return null;
        return this._ThreadProvider.Query("Fetch", [KeyOrPath]);
    }
    ...
    async Erase (...Keys) {
        if (!this._ThreadProvider) return null;
        return this._ThreadProvider.Query("Erase", Keys);
    }
