...
class Connection extends BaseConnection {
     ...
     * @param {Dotaccess} [Pathlike] Optional dotaccess path pointing towards what to serialise.
    ...
    Fetch (KeyOrPath) {
        ...
        if (this.Cache.has(Key)) this.Cache.set(Key, Fetched instanceof Array ? [...Fetched] : {...Fetched});
