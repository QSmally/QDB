...
class Selection {
     ...
     * @param {Function} Fn Function which either determines the sort order with given arguments `a` and `b`
     ...
     * @returns {Selection}
     */
    Order (Fn, Preset = "arbitrary") {
        const SortOrderMethod = {
            "ascending": (a, b) => Fn(a) - Fn(b),
            "descending": (a, b) => Fn(b) - Fn(a),
            "arbitrary": Fn
        }[Preset];
